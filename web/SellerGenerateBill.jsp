...
<html class="noIE" lang="en-US">
    ...
    <head>
        ...
        <title>Generate Bill Page</title>
    ...
    <body id="bill">
        ...
        <h1 style="font-family: monospace;font-size: 40px;color: whitesmoke;text-align: center">Category Wise List for employee<%=cu2.getSellerID()%></h1>
        
       
        
        <div style="margin-top: 50px">
        
            <form method="post" action="SellerReceiveRequestServlet" style="text-align: center;color:white">
                UserID <input type="text" name="theUserID" style="margin-left: 50px"></input>
                <br>
                <br>
                  <input class="loginbutton" onclick="showVeg()" type="button" value="Vegetables" id="b2"></input>
            ...
            <br>
            <input class="loginbutton" onclick="showChockolates()" type="button" value="Chockolates" id="b8" ></input>
            ...
            <br>
            <table id="b7" style="display: none">
                <th></th>
                <th></th>
                <th>Item</th>
                <th>Price</th>
