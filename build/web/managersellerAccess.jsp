...
<html class="noIE" lang="en-US">
    ...
    <body id="mseller">
        ...
        <form style="text-align: center;margin-left: 300px">
            <table>
                ...
                <tr>
                    <td>UserName</td>
                    <td><input type="text1" id="t1" value="<%= rs.getInt("id")%>" readonly="readonly"></td>
                    <td><input type="button" value="Edit"  onclick="makeEditable('t1')" style="background-color: chocolate"/></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td><input type="text2" id="t2" value="<%= rs.getInt("password")%>" readonly="readonly"></td>
        ...
        <!--<div style="color:white;margin-left: 500px;font-size: 25px">
            UserName <input type="text1" id="t1" value="<%= rs.getInt("id")%>" readonly="readonly">
            <input type="button" value="Edit"  onclick="makeEditable('t1')" style="background-color: chocolate"/>

            <br>
            <br>
            PassWord <input type="text2" id="t2" value="<%= rs.getInt("password")%>" readonly="readonly"> 
    ...
    <script>
        var prevID;
        var prevPass;
        prevID = document.getElementById('t1').value.toString();
        prevPass = document.getElementById('t2').value.toString();
        //alert(prevID);
        ...
        function saveIt() {
            ...
            if (prevID != text || prevPass != text2)
            {
                alert("Change confirm??");
                var jspcall = "managerSeller?id=" + text + "&pas=" + text2;
