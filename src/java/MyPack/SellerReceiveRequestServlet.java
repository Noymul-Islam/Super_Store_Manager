 ...
 * @author DELL
 */
public class SellerReceiveRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String userID = request.getParameter("theUserID");
        ...
        cu2.setID(userID);
        cu2.setName(dc.getUserName(userID));
        ...
        response.sendRedirect("GeneratedBill2.jsp");
    }
