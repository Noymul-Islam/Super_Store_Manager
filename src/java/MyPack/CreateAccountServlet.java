...
public class CreateAccountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if((userName != null && !userName.isEmpty())&&(password != null && !password.isEmpty())&&(phoneNumber != null && !phoneNumber.isEmpty())&&(city != null && !city.isEmpty())&&(area != null && !area.isEmpty())&&(houseNumber != null && !houseNumber.isEmpty())){
       ...
       dc.insertTotalPurchased(userID,0);
